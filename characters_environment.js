...
function game(){
  ...
  console.log("The X of Nose is " + noseX + "and the Y of the Nose is " + noseY + "!");
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Play Button to Start and Play! Have Fun! ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function startGame() {
  gameStatus = "start";
  document.getElementById("status").innerHTML = "Game is Loading! Hang Tight.";
}
